	...
	<body>
		<div class="box" style="background-color: <?php echo $bgwarna;?>">
			<div class="display"><input type="text" readonly size="14" id="d"></div>
			<div class="keys">
			    <p>
				    ...
				    <input type="button" class="button gray" value="/" style="font: small Verdana,sans-serif;" onclick='v("/")'>
				</p>
			    <p>
			    ...
			    <p>
			    	...
			    	<input type="button" class="button black" value="=" style="font: small Verdana,sans-serif;" onclick='e()'>
			    </p>
			</div>
		</div>
