...
$c=$jml->row_array();
if($tombol==1){
$namafile=$c['bulan']."_".$b['kategori_nama'];
...
<head>
    <title>Laporan Pemjualan Per Kategori</title>
    <meta charset="utf-8">
...
<tr>
    <td colspan="2" style="width:800px;paddin-left:20px;"><center><h4>LAPORAN PENJUALAN PER KATEGORI</h4></center><br/></td>
</tr>
<tr>
...
<thead>
<tr>
    <th colspan="11" style="text-align:left;">Nama Kategori : <?php echo $b['kategori_nama'].' / '.$b['suplier_nama'];?></th>
</tr>
<tr>
...
<tr>
    ...
    <th class="garis">Kategori Nama</th>
    <th class="garis">Barang Nama</th>
...
$no=0;
    foreach ($data->result_array() as $i) {
        ...
        $barang_nm=$i['barang_nama'];
        $barang_spc=$i['barang_spesifikasi'];
?>
    <tr>
        ...
        <td class="garis" style="text-align:left;"><?php echo $kategori;?></td>
        <td class="garis" style="text-align:left;"><?php echo $barang_nm.'/'.$barang_spc;?></td>
