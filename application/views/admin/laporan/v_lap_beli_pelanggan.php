...
<tr>
    <td colspan="9" style="width:800px;paddin-left:20px;"><center><h4>LAPORAN PENJUALAN PER PELANGGAN</h4></center></td>
</tr>
<tr>
...
<tr>
    <th colspan="9" style="text-align:left;">Bulan ke : <?php echo $c['bulan'];?></th>
</tr>
<tr>
    <th colspan="9" style="text-align:left;">Merek : <?php echo $b['kategori_nama'];?></th>
</tr>
<tr>
...
?>
    ...
    <tr">
        ...
        <th class="garis" style="background-color:#E0FFFF;">Subtotal</th>
        <th class="garis" style="background-color:#E0FFFF;">SubPajak</th>
        <th class="garis" style="background-color:#E0FFFF;">Total</th>
    </tr>
    <?php 
    $noo=0;
    foreach ($detail->result_array() as $j) :
        if($j['jual_fak']==$fak AND $j['kategori_id']==$katid):
            $noo++;?>
            <tr>
                ...
                <td class="garis" style="text-align:left;"><?php echo $j['barang_nama'].' '.$j['barang_spesifikasi'];?></td>  
