    ...
    <!-- Page Content -->
        ...
        <div class="row">
            <div class="col-lg-12">
                <table class="table table-bordered table-condensed" style="font-size:11px;margin-top:10px;">
                    ...
                    <tbody>
                        ...
                        <tr>
                             ...
                             <td style="text-align:center;"><a href="<?=base_url().'admin/penjualan_grosir/remove/'.$items['rowid'];?>" class="btn btn-warning btn-xs"><span class="fa fa-close"></span> Batal</a></td>
                        </tr>
                ...
                <form action="<?=base_url().'admin/penjualan_grosir/simpan_penjualan_grosir'?>" method="post">
                    ...
                    <div class="modal-body" style="overflow:scroll;height:500px;">
                        <table class="table table-bordered table-condensed" style="font-size:11px;" id="mydata">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <form action="<?=base_url().'admin/penjualan_grosir/add_to_cart'?>" method="post">
