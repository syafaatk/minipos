    ...
    <!-- Page Content -->
            <div class="col-lg-12">
                <h1 class="page-header">Transaksi
                    <small>Penjualan Non Faktur</small>
        ...
        <div class="row">
            <div class="col-lg-12">
                <table class="table table-bordered table-condensed" style="font-size:11px;margin-top:10px;">
                    ...
                    <tbody>
                        ...
                        <tr>
                             ...
                             <td style="text-align:center;"><a href="<?=base_url().'admin/penjualan/remove/'.$items['rowid'];?>" class="btn btn-warning btn-xs"><span class="fa fa-close"></span> Batal</a></td>
                        </tr>
                ...
                <form action="<?=base_url().'admin/penjualan/simpan_penjualan'?>" method="post">
                <table class="table table-bordered table-condensed">
                    ...
                    <tr>
                        ...
                        <?php $pajak=$this->cart->total()*0/100;$totpajak=$this->cart->total()+$pajak; ?>
                    ...
                    <div class="modal-body" style="overflow:scroll;height:500px;">
                        <table class="table table-bordered table-condensed" style="font-size:11px;" id="mydata">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <form action="<?=base_url().'admin/penjualan/add_to_cart'?>" method="post">
                                    <input type="hidden" name="kobar" required style="width:80px;" value="<?=$d_barang_id;?>">
                                    <td><span class="btn btn-xs btn-info"><?=$kategori;?></td></span>
                                    <td>
        ...
        $(document).ready(function(){
            ...
            $("#kode_brg").on("input",function(){
                var kobar = {kode_brg:$(this).val()};
                   $.ajax({
               type: "POST",
               url : "<?=base_url().'admin/penjualan/get_barang';?>",
               data: kobar,
